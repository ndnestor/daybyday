...
public class ProfileScreen : MonoBehaviour {
    ...
    private readonly Hashtable activityTimes = new Hashtable();
    ...
    private void Start() {
        ...
        activityTimes[Interaction.Plant] = 0;
        activityTimes[Interaction.Piano] = 0;
        activityTimes[Interaction.YogaMat] = 0;
        activityTimes[Interaction.Computer] = 0;
        activityTimes[Interaction.Bookshelf] = 0;
        activityTimes[Interaction.Window] = 0;
        activityTimes[Interaction.Other] = 0;
    }
    ...
    // TODO: Switch to enum based activity name
    ...
    private void UpdateBarChartSameOrder(Interaction interaction, int timeUsed) {
        activityTimes[interaction] = (int)activityTimes[interaction] + timeUsed;
        ...
        foreach(Interaction currInteraction in Enum.GetValues(typeof(Interaction))) {
            ...
            // Set its dimensions
            float barHeight = (int)activityTimes[currInteraction] * timeUnitHeight;
            newBarChartSection.transform.localScale = new Vector3(barWidth, barHeight, 1);
    ...
    private void Update() {
        if(Input.GetKeyDown(KeyCode.B)) {
            ...
            int randomIndex = Random.Range(0, activityNames.Length - 1);
