...
namespace NotePad{
    public class OpenNotepadCombined2 : MonoBehaviour
    {
        ...
        public void Start () {
            ...
            tmpColor = Instantiate(notesCol, new Vector3(10.3f, 1.923f, 0.0f), Quaternion.identity);
            tmpBW = Instantiate(notesBW, new Vector3(10.3f, 1.923f, 0.0f), Quaternion.identity);
